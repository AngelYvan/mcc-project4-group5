...
\subsection{Concepto}
Un Arbol KD ( o KD Tree) es una estructura de datos de particionado del espacio que organiza los puntos en un Espacio euclídeo de k dimensiones.
...
Se realizará una app que permita el desarrollo del algoritmo Kdtree. 
